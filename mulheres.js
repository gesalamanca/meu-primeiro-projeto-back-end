...
const cors = require('cors') // aqui estou iniciando o cors que permite consumir essa api no frontend
...
app.use(cors()) // aqui estou configurando o app para usar o cors
